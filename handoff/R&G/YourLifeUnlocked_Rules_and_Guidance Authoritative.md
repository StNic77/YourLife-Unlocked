...
*Living Document — Updated Each Session | Last Revised: May 31, 2026 (Session 27) | Authoritative Consolidated Version | Confidential*
...
If Claude has not done this, Shawn stops the session until it is done. This is non-negotiable. The project knowledge is the authority. Working from memory or momentum produces drift. Drift compounds. Twenty-seven sessions of coherent work depends on this standard being held at the start of every session.
...
**A full SHAPE Definition Document has been written (Session 27) and is in the project. Read it before any Sanctuary build begins. No exceptions.**
...
**A full Sanctuary Spec must be written before any build begins. A Sanctuary Prompt Brief follows the spec. The SHAPE Definition Document exists (Session 27). The Sanctuary Spec is next.**
...
*Your Life: Unlocked | Rules & Guidance | Living Document | Authoritative Consolidated Version | Confidential*
*This file supersedes all previous versions. Add to project, remove all prior R&G versions.*
