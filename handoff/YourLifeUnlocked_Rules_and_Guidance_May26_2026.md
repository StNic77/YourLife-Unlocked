...
*Living Document — Updated Each Session | Last Revised: May 26, 2026 | Confidential*
...
If Claude has not done this, Shawn stops the session until it is done. This is non-negotiable. The project knowledge is the authority. Working from memory or momentum produces drift. Drift compounds. Nineteen sessions of coherent work depends on this standard being held at the start of every session.
